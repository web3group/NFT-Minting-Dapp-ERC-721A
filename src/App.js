  ...
  return (
    <s.Screen style={{backgroundImage: "linear-gradient(var(--bg-angle), var(--primary) 0%, var(--secondary) 74%)"}}>
      ...
      >
        ...
        <s.SpacerSmall />
        <ResponsiveWrapper flex={1} style={{backgroundImage:"linear-gradient(var(--main-angle), var(--main-bg-primary) 0%, var(--main-bg-secondary) 74%)", padding: 24, borderRadius:"var(--main-rarius)", border:`3.4px solid var(--main-border)`}} test>
